...
// ill place, here is markdown to trigger personal github issue associations
// https://github.com/espressif/esp32-camera/issues/534#issuecomment-1564840560
#define MY_PATCH
#ifndef MY_PATCH
// this
...
// replacement advised in guthub issue
...
// my additions from "......" area in issue
#include "soc/gpio_periph.h"
static inline int gpio_ll_get_level(gpio_dev_t *hw, int gpio_num)
{
    if (gpio_num < 32) {
